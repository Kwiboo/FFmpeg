...
static int v4l2_request_h264_init(AVCodecContext *avctx)
{
    ...
    ret = ff_v4l2_request_init(avctx, V4L2_PIX_FMT_H264_SLICE, 4 * 1024 * 1024,
                               control, FF_ARRAY_ELEMS(control));
    if (ret)
        return ret;

    // FIXME: check V4L2_CID_MPEG_VIDEO_H264_PROFILE control
    // FIXME: check V4L2_CID_MPEG_VIDEO_H264_LEVEL control
